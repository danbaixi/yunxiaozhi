...
App({
   ...
   */
  getDomain:function(){
    return this.globalData.isDebug ? (this.globalData.isTest ? 'https://www.yunxiaozhi.cn/test/public/api/' : 'http://danbaixi.utools.club/yxz_v1/public/api/') : 'https://www.yunxiaozhi.cn/v1/public/api/'
  },
