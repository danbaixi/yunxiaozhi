...
App({
   ...
   */
  getDomain:function(){
    return this.globalData.isDebug ? (this.globalData.isTest ? 'https://www.yunxiaozhi.cn/test/public/api/' : 'https://danbaixi.utools.club/yunxiaozhi/public/index.php/api/') : 'https://www.yunxiaozhi.cn/v1/public/api/'
  },
