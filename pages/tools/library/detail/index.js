...
Page({
  ...
  onShareAppMessage: function () {
    ...
    const path = `/pages/tools/library/detail/index?id=${this.data.id}&img=${encodeURIComponent(this.data.img)}`
  ...
  viewDetail(e) {
    ...
    const url = `/pages/tools/library/detail/index?id=${id}&img=${img ? encodeURIComponent(img) : ''}`
